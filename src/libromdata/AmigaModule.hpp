 ...
 * AmigaModule.hpp: Amiga Module reader.                               *
 *                                                                         *
...
#ifndef __ROMPROPERTIES_LIBROMDATA_AMIGAMODULE_HPP__
#define __ROMPROPERTIES_LIBROMDATA_AMIGAMODULE_HPP__
...
class AmigaModulePrivate;
class AmigaModule : public LibRpBase::RomData
{
	public:
		/**
		 ...
		 */
		explicit AmigaModule(LibRpBase::IRpFile *file);
	...
	private:
		...
		friend class AmigaModulePrivate;
		RP_DISABLE_COPY(AmigaModule)
...
#endif /* __ROMPROPERTIES_LIBROMDATA_AmigaModule_HPP__ */
